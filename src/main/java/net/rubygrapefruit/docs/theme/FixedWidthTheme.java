...
public class FixedWidthTheme extends DefaultTheme implements HtmlTheme {
    public void writeStyleRules(Appendable target) throws IOException {
        ...
        target.append(
                "body { width: 780px; background-color: white; margin-left: auto; margin-right: auto; padding-left: 4em; padding-right: 4em; padding-top: 1em; padding-bottom: 1em; margin-top: 3em; border: solid #d0d0d0 1px; }\n");
